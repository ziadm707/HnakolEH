package com.example.hnakoleh.model;
...
public class MealsDB {
    ...
    public void getBreakfastData(final TextView names , final TextView ingredients , final TextView steps) {
        ...
        FirebaseDatabase.getInstance().getReference().child("Database").child("Breakfast").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
    ...
    public void getLunchData(final TextView names , final TextView ingredients , final TextView steps) {
        ...
        FirebaseDatabase.getInstance().getReference().child("Database").child("Launch").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
    ...
    public void getDinnerData(final TextView names , final TextView ingredients , final TextView steps) {
        ...
        FirebaseDatabase.getInstance().getReference().child("Database").child("Dinner").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
